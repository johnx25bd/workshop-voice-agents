...
5. **[Phase 5: Telephony](docs/phase-5.md)** — Connect your agent to a phone number (stretch goal)

If you get stuck on any phase, each tutorial page includes full solution code in a dropdown. Working solutions are also available on the `phase-n` branches for reference.
